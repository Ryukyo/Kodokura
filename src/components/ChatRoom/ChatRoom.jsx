        ...
        .on(
          ...
          (resp) => {
            ...
            if (messages.length > 0 && currentUserId === matchResult.user1.id) {
              ...
              const text = lastMessage.message;
              const lowercaseText = text.toLowerCase()
              if (lowercaseText.includes("fucking kodobot") || lowercaseText.includes("stupid kodobot") || lowercaseText.includes("asshole kodobot") || lowercaseText.includes("motherfucker kodobot") || lowercaseText.includes("stupid bot") || lowercaseText.includes("moron kodobot")) {
